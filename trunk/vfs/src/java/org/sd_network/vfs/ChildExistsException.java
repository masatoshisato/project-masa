...
/**
 * A exception for user authentication error.
 *
 * <p> $Id$
 *
 * @author Masatoshi Sato
 */
public class ChildExistsException
    extends Exception
{
    //////////////////////////////////////////////////////////// 
    // Constructors.
     ...
     */
    public ChildExistsException(Exception exception) {
        super(exception);
    }
     ...
     */
    public ChildExistsException(String message, Exception exception) {
